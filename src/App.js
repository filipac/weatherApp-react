...
class App extends React.Component {
  ...
  getWeather = async e => {
    ...
    const api_call = await fetch(
      `http://api.openweathermap.org/data/2.5/weather?q=${city},${country}&appid=${API_KEY}&units=${
        this.state.weatherUnit
      }`
    );
            ...
            <div className="container-fluid">
              <div className="row">
                ...
                <div className="col-7 form-container">
                  ...
                  <Weather
                    temperature={
                      (showPrevious ? this.state.previous : this.state.current)
                        .temperature
                    }
